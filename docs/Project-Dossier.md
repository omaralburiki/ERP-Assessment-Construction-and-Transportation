...
```mermaid
flowchart TD
    A[8 Departments Operating Independently] --> B[Excel / Outlook / WhatsApp / Paper Forms]
    B --> C[No Centralized Database]
    C --> D[Duplicate Data Entry]
    C --> E[Manual Approvals]
...
```mermaid
flowchart TD
    Center((ERP Readiness Assessment))
    Center --- EM[Executive Management]
    Center --- FIN[Finance]
    Center --- PROC[Procurement]
    Center --- PROJ[Projects]
    Center --- WH[Warehouse and Materials]
    Center --- EQ[Equipment and Plant]
    Center --- TRANS[Transportation Operations]
...
flowchart LR
    subgraph Phase1[Phase 1]
        ...
        P1[Procurement]
        PR1[Projects]
        M1[Material Management]
        D1[Document Management]
        A1[Approval Workflows]
    end
    subgraph Phase2[Phase 2]
        HR2[Human Resources]
        PAY2[Payroll]
        EQ2[Equipment Maintenance]
        FL2[Fleet Management]
    end
    subgraph Phase3[Phase 3]
        BI3[Executive Dashboards / BI]
        MOB3[Mobile Access]
        VP3[Vendor Portal]
    end
